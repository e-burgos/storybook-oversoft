    ...
    react_1.default.createElement("div", { className: "storybook-header" },
        ...
        react_1.default.createElement("div", null, user ? (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement("span", { className: "welcome" },
                ...
                "!"),
            react_1.default.createElement(Button_1.default, { size: "small", onClick: onLogout, label: "Log out" }))) : (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(Button_1.default, { size: "small", onClick: onLogin, label: "Log in" }),
            react_1.default.createElement(Button_1.default, { primary: true, size: "small", onClick: onCreateAccount, label: "Sign up" })))))));
